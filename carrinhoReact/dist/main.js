...
function ProductComponent(props) {
  ...
  }, `${props.item.titulo}`), React.createElement('small', null, `R$ ${props.item.preço}`), React.createElement('p', {
    className: "card-text"
  }, `${props.item.descrição}`), React.createElement('button', {
...
function CarrinhoComponent(props) {
  ...
  return React.createElement('div', {
    ...
    return React.createElement('div', {
      ...
      className: "card-title"
    }, props.itens[key].titulo), React.createElement('p', {
      className: "card-text"
    }, `Preço unidade: R$ ${props.itens[key].preço} | Quantidade ${props.itens[key].quantidade}`), React.createElement('p', {
      className: "card-text"
    }, `Valor: R$ ${props.itens[key].preço * props.itens[key].quantidade}`), React.createElement('button', {
      className: "btn btn-danger btn-sm",
      onClick: props.onRemoveItemCarrinho.bind(null, key)
    }, "Remover"));
  }), React.createElement('div', {
    className: "carrinho__total mt-2 p-3"
  }, React.createElement('h6', null, "Total: ", React.createElement('strong', null, `R$ ${valorTotal(props.itens)}`)))));
}
...
function AppComponent(props) {
  ...
  */
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", {
    className: "col-sm-8"
  }, React.createElement(ListaProdutoComponent, null, produtosListas.map(function (produto, index) {
